...
{
    public class XPParticleEffector
    {
        ...
        public static async UniTask SpawnXpParticles(int value,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            await SpawnParticlesAsync(value,
            ...
            CancellationToken cancellationToken)
        {
            for (int i = 0; i < particleCount; i++)
            {
                ...
                particle.GetComponentInChildren<TextMeshProUGUI>().SetText($"+{value}");
