...
//         
//         [SerializeField] private AbstractPriceSlider abstractPriceSlider;
...
//             
//             abstractPriceSlider.minValue = 1;
//             abstractPriceSlider.maxValue = 100;
//             abstractPriceSlider.value = 30;
//             _data.UpdatePrice((int)abstractPriceSlider.value);
...
//             if (addValue)
//             {
//                 abstractPriceSlider.value =  Mathf.Clamp(abstractPriceSlider.value + _sliderStep, abstractPriceSlider.minValue,
//                     abstractPriceSlider.maxValue);
//             }
//             else
//             {
//                 abstractPriceSlider.value =  Mathf.Clamp(abstractPriceSlider.value - _sliderStep, abstractPriceSlider.minValue,
