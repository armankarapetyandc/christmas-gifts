...
namespace SpaceMonkey.Scripts.Installers.Main
{
    public class MainLoader : BaseLoader
    {
        ...
        private async UniTask PatchGameConfig()
        {
            ...
            var levelInfoUnit = _cloudDataService.Patch<LevelInfoPatcher, LevelInfo[]>();
            ...
            await LoadingService.BeginLoadingParallel(
                ...
                simulationInfoUnit, customerReviewUnit, levelInfoUnit
            );
            ...
            _gameConfig.PatchLevelInfo(levelInfoUnit.Result);
