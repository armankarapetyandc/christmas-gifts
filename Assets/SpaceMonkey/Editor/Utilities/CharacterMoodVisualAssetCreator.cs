...
{
    public class CharacterMoodVisualAssetCreator
    {
        [MenuItem("Assets/Create Character Mood Visual Assets From Selection", false, 100)]
        ...
        private static void CreateVisualAsset(Sprite sprite)
        {
            ...
            CharacterMoodVisualAsset asset = ScriptableObject.CreateInstance<CharacterMoodVisualAsset>();
            ...
            Debug.Log($"Created CharacterMoodVisualAsset for: {sprite.name} (id={fixedName})");
        }
